...
[Ladda ner tillägg](https://github.com/annaesvensson/yellow-image/archive/main.zip) och kopiera zip-fil till din `system/extensions` mapp. Högerklicka om du använder Safari.
