...
[Ladda ner tillägg](https://github.com/datenstrom/yellow-extensions/raw/master/downloads/image.zip) och kopiera zip-fil till din `system/extensions` mapp. Högerklicka om du använder Safari.
